...
export class Backend implements backendInterface {
    ...
    async addCommunityLink(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCommunityLink(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteCommunityLink(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCommunityLink(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async editCommunityLink(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editCommunityLink(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCommunityLinks(): Promise<Array<CommunityLink>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCommunityLinks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getModerationCounts(): Promise<ModerationCounts> {
        if (this.processError) {
            try {
                const result = await this.actor.getModerationCounts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateModerationCounts(arg0: ModerationCounts): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateModerationCounts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePaymentInfo(arg0: PaymentInfo): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePaymentInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
